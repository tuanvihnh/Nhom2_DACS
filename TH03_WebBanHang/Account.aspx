...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        <div id="container-pr" class="justify-content-center align-items-center">

            <img src="Content/image-bg/account-background-img.jpg" style="position:absolute; z-index:0; height:18rem; width:46rem; backdrop-filter:blur(20px);  filter: brightness(50%); border-radius:50px;border:1px solid #666;"/>
            <div id="item-pr" style="z-index:1;">
            ...
            <asp:ListView ID="ListViewAccounts" runat="server">
                <ItemTemplate>
                    <div class="pr-info" style="z-index:1; border-top-right-radius:20px;border-bottom-right-radius:20px;border-top-left-radius:0;border-bottom-left-radius:0;             width:max-content; height:max-content; 
 ...
 <h5 class="d-flex" > <p class="h5-pr">Số điện thoại:</p><p class="long-text"><%# Eval("DienThoai") %></p></h5>
        ...
        <div class="justify-content-center align-items-center d-flex" style="gap: 3rem; z-index:1;">
