...
namespace TH03_WebBanHang
{
    public partial class Item : System.Web.UI.Page
    {
        ...
        public IQueryable<TH03_WebBanHang.Models.SanPhamData> GetImages([QueryString("sp")] String sp)
        {
            ...
            IQueryable<SanPhamData> sanPhams = dbcontext.SanPhamDatas.Where(p => p.MaSP == sp);
        ...
        public IQueryable<TH03_WebBanHang.Models.SanPham> GetPhones()
        {
            ...
            {
                return dbcontext.SanPhams.Where(s => s.TenSP.Contains(searchText) || s.MoTa.Contains(searchText) || s.MaSize.Contains(searchText));
            }
            else
            {
               ...
               if (dbcontext.SanPhams.Any(p => p.MaLoai == ls) && (gp == null || gp == ""))
                {
                    return dbcontext.SanPhams.Where(p => p.MaLoai == ls);
                }
                ...
                else if (dbcontext.SanPhams.Any(p => p.MaLoai == ls))
                {
                    return dbcontext.SanPhams.Where(p => p.MaLoai == ls);
                }
        ...
        public IQueryable<TH03_WebBanHang.Models.SanPham> GetDetails([QueryString("sp")] String sp)
        {
            ...
            if (sanPhams.Any(p => p.MaLoai == "1" || p.MaLoai == "3"))
            {
                Response.Write(" <style>\r\n                                #size{\r\n                                    display:flex;\r\n                                }\r\n                            </style>");
            }
            else Response.Write("<style>\r\n                                #size{\r\n                                    display:none;\r\n                                }\r\n                            </style>");
            if (sanPhams.Any(p => p.MaSize == "1")) { Response.Write(" <style>                                .sizeM {\r\n         background:#CCBEB1 !important;\r\n         border-color:#CCBEB1 !important;\r\n     }\r\n        .sizeL {\r\n         background:#fff0 !important;\r\n         border-color:#000 !important;\r\n     }\r\n </style>"); }
            else if (sanPhams.Any(p => p.MaSize == "2")) { Response.Write(" <style>                                .sizeL {\r\n         background:#CCBEB1 !important;\r\n         border-color:#CCBEB1 !important;\r\n     }\r\n        .sizeM {\r\n         background:#fff0 !important;\r\n         border-color:#000 !important;\r\n     }\r\n </style>"); }
            else if (sanPhams.Any(p => p.MaSize == "3")) { Response.Write(" <style>                                .sizeX {\r\n         background:#CCBEB1 !important;\r\n         border-color:#CCBEB1 !important;\r\n     }\r\n        .sizeX {\r\n         background:#fff0 !important;\r\n         border-color:#000 !important;\r\n     }\r\n </style>"); }
        ...
        protected void btnSubmitComment_Click(object sender, EventArgs e)
        {
            ...
            if (khach)
            {
                ...
                if (Rating)
                {
                    ...
                    using (var db = new QL_BTSEntities())
                    {
        ...
        protected void SizeM_Click(object sender, EventArgs e)
        {
            ...
            SanPham sanPhamSL = dbcontext.SanPhams.FirstOrDefault(p => p.MaSP != idsp && p.TenSP == sanPham.TenSP && p.MaSize == "1");
            if (sanPhamSL != null || sanPham.MaSize != "1")
            {
                Response.Redirect("item.aspx?sp=" + sanPhamSL.MaSP);
            }
            else Response.Redirect(url);
        ...
        protected void SizeL_Click(object sender, EventArgs e)
        {
            ...
            //}
            //else Response.Redirect(url);
            SanPham sanPhamSL = dbcontext.SanPhams.FirstOrDefault(p => p.MaSP != idsp && p.TenSP == sanPham.TenSP && p.MaSize == "2");
            if (sanPhamSL != null || sanPham.MaSize != "2")
            {
                if (sanPhamSL != null) {                Response.Redirect("item.aspx?sp=" + sanPhamSL.MaSP);
                }
            ...
            else {Response.Redirect(url); Response.Write("<script>alert('Sản phẩm không tồn tại');</script>");
            }
        }
        protected void SizeX_Click(object sender, EventArgs e)
        {
            string url = HttpContext.Current.Request.Url.ToString();
            ...
            //}
            //else Response.Redirect(url);
            SanPham sanPhamSL = dbcontext.SanPhams.FirstOrDefault(p => p.MaSP != idsp && p.TenSP == sanPham.TenSP && p.MaSize == "3");
            if (sanPhamSL != null || sanPham.MaSize != "3")
            {
                if (sanPhamSL != null)
                {
                    Response.Redirect("item.aspx?sp=" + sanPhamSL.MaSP);
