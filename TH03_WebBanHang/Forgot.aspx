...
<body>
    <img style="filter: brightness(50%); height: 100%; width: 100%; position: absolute; z-index: 0;" src="Content/image-bg/img-shop.jpg" />
    ...
    <form id="form1" runat="server" style="z-index: 1;">
        ...
        <div class="container">
            <div class="form-container sign-up">
                ...
                <a href="Default.aspx" style="text-decoration: none; color: #CCBEB1;">
                    <h1 style="text-align: center; font-weight: bolder; font-family: 'Edwardian Script ITC'; font-size: 4rem; margin-bottom: 1rem; border-bottom-color: #000; border: 1px solid; border-top-style: none; border-left-style: none; border-right: none;">BTS Shop</h1>
                </a>
