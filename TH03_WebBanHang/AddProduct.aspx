...
<body>
    ...
    <label for="fileUpload" style="display:grid; width:max-content; grid-gap:10px;">Chọn Ảnh:<asp:FileUpload ID="fileUpload" runat="server" onchange="previewImage(event)" style=" /*border:1px solid #000;*/ outline:none;"/>
            ...
            <div  style="margin-top:1rem; " class="d-flex">
               ...
               <div class="div-ls"><label for="ddlMaLoai">Size:</label>
    <asp:DropDownList ID="ddlMaSize" runat="server" CssClass="full-width div-ls" style="width:6rem; text-align:center;">
